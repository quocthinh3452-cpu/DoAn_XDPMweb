// ============================================================
// ADMIN MOCK DATA
// Future Laravel endpoints (admin-only, role-protected):
//   GET /api/admin/dashboard   → stats, recent orders, top products
...
export const MOCK_ORDERS = [
  ...
  },
  {
    ...
    items: [
      { name: "Samsung Galaxy S24 Ultra", quantity: 1, price: 1099 },
      { name: "AirPods Pro (2nd gen)",    quantity: 1, price: 229  },
    ],
    total: 1461.12,
    status: "shipped",
  ...
  },
  {
    ...
    items: [{ name: "Sony WH-1000XM5", quantity: 2, price: 349 }],
    total: 773.92,
    status: "confirmed",
    paymentMethod: "cod",
  ...
  },
  {
    ...
    items: [{ name: "Google Pixel 8 Pro", quantity: 1, price: 799 }],
    total: 878.92,
    status: "confirmed",
    paymentMethod: "bank_transfer",
  ...
  },
  {
    ...
    email: "dothif@outlook.com",
    items: [
      { name: "iPad Pro 12.9\"",       quantity: 1, price: 1099 },
      { name: "Samsung Galaxy Watch 6", quantity: 1, price: 279  },
    ],
    total: 1498.12,
    status: "delivered",
    paymentMethod: "ewallet",
  ...
  },
  {
    ...
    items: [{ name: "AirPods Pro (2nd gen)", quantity: 3, price: 229 }],
    total: 756.36,
    status: "cancelled",
    paymentMethod: "cod",
...
export const TOP_PRODUCTS = PRODUCTS
  .map((p) => ({ ...p, sold: Math.floor(Math.random() * 80) + 10, revenue: p.price * (Math.floor(Math.random() * 80) + 10) }))
